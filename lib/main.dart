...
import 'package:store_mundo_pet/clean_architecture/data/datasource/region_service.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<RegionRepositoryInterface>(
          create: (context) => RegionService(),
        ),
        ...
        return ChangeNotifierProvider(
          create: (context) => MainBloc(
            regionRepositoryInterface:
                context.read<RegionRepositoryInterface>(),
