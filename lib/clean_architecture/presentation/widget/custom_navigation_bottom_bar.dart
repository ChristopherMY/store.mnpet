...
class CustomNavigationBottomBar extends StatelessWidget {
  const CustomNavigationBottomBar({
    ...
    this.itemPadding = const EdgeInsets.symmetric(vertical: 00, horizontal: 16),
                    ...
                    child: Padding(
                      padding: itemPadding -
                          (Directionality.of(context) == TextDirection.ltr
                              ? EdgeInsets.only(
                                  right: itemPadding.right * factor)
                              : EdgeInsets.only(
                                  left: itemPadding.left * factor)),
                      child: Row(
                        children: [
                          IconTheme(
                            data: IconThemeData(
                              color: Color.lerp(
                                  unselectedColor, selectedColor, factor),
                              size: 24,
                            ),
